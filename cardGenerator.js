...
const countriesMap = countries.map((countrie) => {
  reducedCountrie = {
    name: countrie.name.official,
    commonName: countrie.name.common,
    timeZones: countrie.timezones,
    map: countrie.maps.googleMaps,
    flagIcon: countrie.flags.png,
    flag: countrie.flags.svg,
  };
  return reducedCountrie;
});

function paintDOM() {
  cardsBox = ``;
  const tagToUpdate = document.getElementById("cards_container");
  countriesMap.map((countrie) => {
    cardsBox += `
        <div class="card">
            <div class="card_content">
                <h2>${countrie.name}</h2>
                <ul>
                    <li><img src="${countrie.flagIcon}" alt="icono2" class="list_icon">${countrie.commonName}</li>
                    <li class="times_list"><img src="./assets/img/time-zone.png" alt="icono2" class="list_icon icon2"><ul>`;

        countrie.timeZones.map(timeZone =>{
            cardsBox += `
                        <li>${timeZone}</li>
            `;
        })
    cardsBox+=`
            ...
            <li><img src="./assets/img/placeholder.png" alt="icono2" class="list_icon"><a href="${countrie.map}">Maps</a></li>
        </ul>
        </div>
        <div class="card_image">
        <img src="${countrie.flag}" alt="bandera" class="center">
        </div>
        </div>
        `
  });
  tagToUpdate.innerHTML = cardsBox;
}
